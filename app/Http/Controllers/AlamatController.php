...
class AlamatController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('customer.pembeli.alamat.index', ['alamat' => $alamat]);
    }
    ...
    {
        return view('customer.pembeli.alamat.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('customer.pembeli.alamat.edit', ['alamat' => $alamat]);
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('customer.pembeli.alamat.index', ['alamat' => $alamat, 'search' => $search]);
    }
}
