...
class OrganisasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.organisasi.index', compact('organisasi', 'search'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.organisasi.show', compact('organisasi', 'requestDonasi'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        */
        ...
        if ($request->hasFile('logo')) {
            ...
            $filename = $organisasi->idOrganisasi . '_' . time() . '.' . $logoFile->getClientOriginalExtension();
            $logoFile->move(public_path('user/organisasi'), $filename);
            $organisasi->logo = 'user/organisasi/' . $filename;
        }
