    ...
    <div class="bg-white shadow-md rounded-lg p-6 max-w-xl mx-auto">
        <div class="flex justify-between items-start mb-4">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('pembeli.alamat.edit', $alamat->idAlamat) }}" class="px-3 py-1 bg-yellow-500 hover:bg-yellow-600 text-white rounded-md text-sm">
                    <i class="fas fa-edit mr-1"></i> Edit
                </a>
                <form action="{{ route('pembeli.alamat.destroy', $alamat->idAlamat) }}" method="POST" class="inline-block"
        ...
        <div class="mt-6">
            <a href="{{ route('pembeli.alamat.index') }}" class="text-green-600 hover:text-green-800">
