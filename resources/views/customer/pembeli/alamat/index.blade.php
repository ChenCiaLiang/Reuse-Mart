...
<div class="container px-6 mx-auto py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <a href="{{ route('pembeli.alamat.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md">
            <i class="fas fa-plus mr-2"></i> Tambah Alamat Baru
        </a>
        
        <form action="{{ route('pembeli.alamat.search') }}" method="GET" class="flex">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="p-4">
                <div class="flex justify-between items-start">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('pembeli.alamat.edit', $a->idAlamat) }}" class="text-yellow-600 hover:text-yellow-800">
        ...
        <div class="col-span-2 bg-gray-100 rounded-lg p-8 text-center">
            ...
            <a href="{{ route('pembeli.alamat.create') }}" class="mt-4 inline-block bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md">
