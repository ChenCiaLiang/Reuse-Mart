...
<div class="container px-6 mx-auto py-8">
    <h1 class="text-2xl font-semibold text-gray-900 mb-6">Tambah Alamat Baru</h1>
        ...
        <form action="{{ route('alamat.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="alamatLengkap" name="alamatLengkap" required
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                          rows="4" placeholder="Masukkan alamat lengkap termasuk kecamatan, kota/kabupaten, dan kode pos">{{ old('alamatLengkap') }}</textarea>
            </div>
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('alamat.index') }}" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 rounded-md">
                    Batal
                </a>
