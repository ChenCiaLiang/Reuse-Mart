...
<head>
    ...
    <title>Registrasi Organisasi - ReUseMart</title>
    <style>
        .register-bg {
...
<body class="register-bg min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center p-4">
        <div class="bg-white bg-opacity-90 rounded-3xl shadow-lg p-8 w-full max-w-md">
            <h2 class="text-2xl font-bold text-center mb-6">Registrasi Organisasi</h2>

            <!-- Logo -->
            <div class="flex justify-center mb-6">
                <div class="rounded-lg p-2 w-32 h-16 flex flex-col items-center justify-center">
                    <img src="{{ asset('/images/Logo/Logo.jpg') }}" alt="ReUseMart Logo">
                    <span class="text-xs text-gray-600">Giving Items a Second Life</span>
                </div>
            </div>

            <!-- Register Form -->
            <form method="POST" action="{{ route('register.organisasi.submit') }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="mb-4">
                    <label for="nama" class="block text-gray-800 font-medium mb-2">Nama Organisasi</label>
                    <input type="text" id="nama" name="nama" placeholder="Nama Organisasi" value="{{ old('nama') }}" required
                ...
                <!-- Alamat Field -->
                <div class="mb-4">
                    <label for="alamat" class="block text-gray-800 font-medium mb-2">Alamat Lengkap</label>
                    <textarea id="alamat" name="alamat" placeholder="Alamat lengkap organisasi" required
