    ...
    <main class="flex-grow flex items-center justify-center p-4">
        <div class="bg-white bg-opacity-90 rounded-3xl shadow-lg p-8 w-full max-w-md">
            ...
            <form method="POST" action="{{ route('login.submit') }}">
                ...
                <!-- Username Field -->
                <div class="mb-4">
                    <label for="loginID" class="block text-gray-800 font-medium mb-2">Email / Username</label>
                    <input type="text" id="loginID" name="loginID" placeholder="Email / Username" value="{{ old('loginID') }}" required
