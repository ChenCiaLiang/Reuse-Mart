    ...
    <main class="flex-grow flex items-center justify-center p-4">
        <div class="bg-white bg-opacity-90 rounded-3xl shadow-lg p-8 w-full max-w-md">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <!-- Username Field -->
                <div class="mb-4">
                    <label for="login" class="block text-gray-800 font-medium mb-2">Username</label>
                    <input type="text" id="login" placeholder="Email / Username"
            ...
            <div class="mt-3 text-center">
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <div class="flex justify-center gap-1">
                        <button href="{{ route('register.pembeli') }}"
                            class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-8 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500">
                            Daftar sebagai Pembeli
                        </button>
                        <button href="{{ route('register.organisasi') }}"
                            class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-8 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500">
