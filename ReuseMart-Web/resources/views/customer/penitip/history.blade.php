    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="bg-green-500 px-6 py-4 flex justify-between items-center">
                ...
                <a href="{{ route('penitip.profile') }}" class="text-white bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-sm">
            ...
            <div class="p-6 border-b border-gray-200">
                <form method="GET" action="{{ route('penitip.history') }}" class="flex flex-wrap items-end gap-4">
                    <div>
            ...
            <div class="p-6">
                ...
                @else
                    <div class="text-center py-12 bg-gray-50 rounded-lg">
                        ...
                        <a href="{{ route('penitip.profile') }}" class="text-green-600 hover:text-green-900">
                            Kembali ke profil
                        </a>
                    </div>
                @endif
